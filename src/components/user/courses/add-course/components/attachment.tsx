...
const Attachment = ({ slug, initialData, refetch }: TitleFormProps) => {
    ...
    <div className="mt-6 dark:bg-neutral-900 rounded-md p-2 px-4">
      <div className="font-medium flex items-center justify-between">
        ...
        <Button
          ...
          className="p-2 gap-1"
        >
          {isEditing ? "Cancel" : (initialData.image ? <><LuPencilLine size={16} /> Upload Attachment</> : <><IoIosAddCircleOutline /> Add Attachment</>)}
        </Button>
      </div>
